                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group row">
                            <label for="name" class="col-md-3 col-form-label">Hobbies</label>
                            <div class="col-md-9">
                              <p class="form-control-plaintext text-muted">{{ $contact->hobbies}}</p>
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <p class="form-control-plaintext text-muted">{{ $contact->company->name}} One</p>
                            </div>
                          </div>
                          <hr>
