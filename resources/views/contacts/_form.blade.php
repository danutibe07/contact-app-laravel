<div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group row">
        <label for="hobbies" class="col-md-3 col-form-label">Hobbies</label>
        <div class="col-md-9">
          <input type="text" name="hobbies" id="hobbies" value="{{ old('hobbies' , $contact->hobbies) }}" class="form-control @error('hobbies') is-invalid @enderror">
          @error('hobbies')
          <div class="invalid-feedback">
           {{ $message }}
          </div>
